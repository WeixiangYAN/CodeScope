...
def parse_arguments():
    ...
    parser.add_argument('--result_save_name', default='code_opt_infer_llama2.jsonl', type=str)
    parser.add_argument('--log_file_name', default='code_opt_infer_llama2.log', type=str)
