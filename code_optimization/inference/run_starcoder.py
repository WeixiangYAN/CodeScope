...
def parse_arguments():
    ...
    parser.add_argument('--result_save_name', default='code_opt_infer_starcoder.jsonl', type=str)
    parser.add_argument('--log_file_name', default='code_opt_infer_starcoder.log', type=str)
