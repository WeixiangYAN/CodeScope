...
def parse_arguments():
    ...
    parser.add_argument('--checkpoint', default='WizardLM/WizardCoder-1B-V1.0',
                        choices=['WizardLM/WizardCoder-1B-V1.0', 'WizardLM/WizardCoder-3B-V1.0',
                                 'WizardLM/WizardCoder-15B-V1.0'], type=str)
    parser.add_argument('--data_load_name', default='code_repair_data.jsonl', type=str)
    parser.add_argument('--result_save_name', default='code_repair_eval_wizardcoder.jsonl',type=str)
    parser.add_argument('--log_file_name', default='code_repair_eval_wizardcoder.logs',type=str),
...
def add_code_repairing(example):
    """
     Generate corresponding code based on the problem description and buggy code
