...
def parse_arguments():
    ...
    parser.add_argument('--result_save_name', default='code_repair_eval_vicuna.jsonl',type=str)
    parser.add_argument('--log_file_name', default='code_repair_eval_vicuna.logs',type=str),
