...
def parse_arguments():
    ...
    parser.add_argument('--result_save_name', default='code_translation_eval_codellama.jsonl', type=str)
    parser.add_argument('--log_file_name', default='code_translation_eval_codellama.logs', type=str)
