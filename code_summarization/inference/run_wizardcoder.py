...
def parse_arguments():
    ...
    parser.add_argument('--result_save_name', default='code_summ_infer_wizardcoder.jsonl', type=str)
    parser.add_argument('--log_file_name', default='code_summ_infer_wizardcoder.log', type=str)
